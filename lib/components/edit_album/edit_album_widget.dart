...
class _EditAlbumWidgetState extends State<EditAlbumWidget> {
  ...
  void initState() {
    ...
    _model.folderTitleTextController1 ??=
        TextEditingController(text: widget.albumRef?.title);
    _model.folderTitleFocusNode1 ??= FocusNode();

    _model.folderTitleTextController2 ??=
        TextEditingController(text: widget.albumRef?.description);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'wq8ph1u7' /* Add album details below! */,
                  ),
              ...
              if (!(isWeb
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('EDIT_ALBUM_COMP_Annual_ON_TAP');
                      ...
                      await widget.albumRef!.reference
