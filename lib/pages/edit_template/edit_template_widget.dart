...
class EditTemplateWidget extends StatefulWidget {
  ...
  final TemplatesRecord? templateref;
  final DocumentReference? templat;
...
class _EditTemplateWidgetState extends State<EditTemplateWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'EditTemplate'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('EDIT_TEMPLATE_EditTemplate_ON_INIT_STATE');
      logFirebaseEvent('EditTemplate_action_block');
    ...
    _model.nameinputTextController ??=
        TextEditingController(text: widget.templateref?.name);
    _model.nameinputFocusNode ??= FocusNode();

    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController1?.text = FFLocalizations.of(context).getText(
            'ughjcatl' /* Your_UserName */,
          );
    ...
    return GestureDetector(
      ...
      child: Scaffold(
            ...
            children: [
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('EDIT_TEMPLATE_PAGE_Icon_lbstsbxv_ON_TAP');
              ...
              InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('EDIT_TEMPLATE_PAGE_Text_t3ny5cnp_ON_TAP');
                ...
                children: [
                      ...
                      if (currentUserEmailVerified) {
                        return Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'EDIT_TEMPLATE_Container_cedvqsvf_ON_TAP');
                        ...
                        return Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'EDIT_TEMPLATE_Container_4s8cy1ah_ON_TAP');
                              logFirebaseEvent('Container_haptic_feedback');
                              HapticFeedback.lightImpact();
                              logFirebaseEvent('Container_bottom_sheet');
                              await showModalBottomSheet(
                  ...
                  AuthUserStreamWidget(
                    builder: (context) => InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'EDIT_TEMPLATE_Container_3bfjir44_ON_TAP');
                        logFirebaseEvent('Container_haptic_feedback');
                        HapticFeedback.lightImpact();
        ...
        body: Stack(
          ...
          children: [
            StreamBuilder<TemplatesRecord>(
              stream:
                  TemplatesRecord.getDocument(widget.templateref!.reference),
              builder: (context, snapshot) {
                ...
                final columnTemplatesRecord = snapshot.data!;
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'EDIT_TEMPLATE_PAGE_Text_6bkay8bb_ON_TAP');
                                  logFirebaseEvent('Text_navigate_to');
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ToggleIcon(
                                    onPressed: () async {
                                      await columnTemplatesRecord.reference
                                          .update({
                                        ...mapToFirestore(
                                          {
                                            'dynamic_profile':
                                                !columnTemplatesRecord
                                                    .dynamicProfile,
                                          },
                                        ),
                                      });
                                    },
                                    value: columnTemplatesRecord.dynamicProfile,
                                    onIcon: Icon(
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'EDIT_TEMPLATE_PAGE_upload_ICN_ON_TAP');
                                                      logFirebaseEvent(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ToggleIcon(
                                    ...
                                    value: columnTemplatesRecord.dynamicText,
                                    onIcon: Icon(
                                      Icons.check_circle_outlined,
                                      color:
                                          FlutterFlowTheme.of(context).primary,
                                    ...
                                    onPressed: () async {
                                      await columnTemplatesRecord.reference
                                        ...
                                        ...mapToFirestore(
                                          {
                                            'video':
                                                !columnTemplatesRecord.video,
                                          },
                                        ),
                                      });
                                    },
                                    value: columnTemplatesRecord.video,
                                    onIcon: Icon(
                                      Icons.check_circle_outlined,
                                      color:
                                          FlutterFlowTheme.of(context).primary,
                                            ...
                                            child: FlutterFlowDropDown<String>(
                                              ...
                                              options: List<String>.from(
                                                  ElevenLabsGroup.voicesCall
                                                      .previewurl(
                                                containerVoicesResponse
                                                    .jsonBody,
                                              )!),
                                              optionLabels: ElevenLabsGroup
                                                  .voicesCall
                                                  .name(
                                                containerVoicesResponse
                                                    .jsonBody,
                                              ...
                                              onChanged: (val) async {
                                                ...
                                                logFirebaseEvent(
                                                    'EDIT_TEMPLATE_DropDownVoice_ON_FORM_WIDG');
                                                logFirebaseEvent(
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '4frzn0md' /* Create your own AI voice */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'kb72btf2' /* Upload a 3-5 minute audio and ... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                  ...
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'EDIT_TEMPLATE_graphic_eq_sharp_ICN_ON_TA');
                                          logFirebaseEvent(
                                              'IconButton_upload_media_to_firebase');
                                          final selectedMedia =
                                              await selectMediaWithSourceBottomSheet(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'imk3vbs6' /* Save AI Audio as a template */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                  ...
                                  Align(
                                    ...
                                    child: FlutterFlowIconButton(
                                      ...
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'EDIT_TEMPLATE_save_rounded_ICN_ON_TAP');
                                        logFirebaseEvent(
                                            'IconButton_upload_media_to_firebase');
                                        final selectedMedia =
                                            await selectMediaWithSourceBottomSheet(
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'EDIT_TEMPLATE_Container_shch9fhn_ON_TAP');
                                              logFirebaseEvent(
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'EDIT_TEMPLATE_Container_ws770pa6_ON_TAP');
                                            logFirebaseEvent(
                                                'Container_haptic_feedback');
                                            HapticFeedback.selectionClick();
                                            logFirebaseEvent(
                            ...
                            Align(
                              ...
                              child: FlutterFlowDropDown<String>(
                                controller: _model.dropDownBGValueController ??=
                                    FormFieldController<String>(
                                  _model.dropDownBGValue ??=
                                      widget.templateref?.bgType,
                                ),
                                options: [
                                  FFLocalizations.of(context).getText(
                                    '86hz89if' /* Background ImageVideo */,
                                  ),
                                  FFLocalizations.of(context).getText(
                                    '4iwtet3j' /* Pick a Color */,
                                  )
                                ],
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'EDIT_TEMPLATE_Container_tbawclol_ON_TAP');
                                        logFirebaseEvent(
                                        ...
                                        logFirebaseEvent(
                                            'Container_update_page_state');
                                        _model.pickedcolor = _model.pickedcolor;
                                      },
                                      child: Container(
                                        width: 100.0,
                                        height: 49.0,
                                        decoration: BoxDecoration(
                                          color: columnTemplatesRecord.color ==
                                                  null
                                              ? _model.colorPicked
                                              : widget.templateref?.color,
                                          borderRadius:
                                  ...
                                  ToggleIcon(
                                    onPressed: () async {
                                      await columnTemplatesRecord.reference
                                        ...
                                        ...mapToFirestore(
                                          {
                                            'watermark': !columnTemplatesRecord
                                                .watermark,
                                          },
                                        ),
                                      });
                                    },
                                    value: columnTemplatesRecord.watermark,
                                    onIcon: Icon(
                                      Icons.check_circle_outlined,
                                      color:
                                          FlutterFlowTheme.of(context).primary,
                            ...
                            if (!(isWeb
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'EDIT_TEMPLATE_UPDATE_TEMPLATE_BTN_ON_TAP');
                                    logFirebaseEvent('Button_haptic_feedback');
                                    HapticFeedback.lightImpact();
                                    logFirebaseEvent('Button_backend_call');

                                    await widget.templateref!.reference
                                        .update(createTemplatesRecordData(
                                      dynamicProfile: _model.dynamicProfile,
                                      dynamicText: _model.dynamicProfile,
                                      video: widget.templateref?.video,
                            ...
                            if (!(isWeb
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'EDIT_TEMPLATE_DELETE_TEMPLATE_BTN_ON_TAP');
                                    logFirebaseEvent('Button_haptic_feedback');
                                    HapticFeedback.lightImpact();
                                    logFirebaseEvent('Button_backend_call');
                                    await widget.templateref!.reference
