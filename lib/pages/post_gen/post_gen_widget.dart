...
import 'post_gen_model.dart';
export 'post_gen_model.dart';

class PostGenWidget extends StatefulWidget {
  const PostGenWidget({
    super.key,
  ...
  final dynamic tweetinfo;
  final dynamic screenname;

  @override
  State<PostGenWidget> createState() => _PostGenWidgetState();
}

class _PostGenWidgetState extends State<PostGenWidget> {
  late PostGenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostGenModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'PostGen'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('POST_GEN_PAGE_PostGen_ON_INIT_STATE');
      logFirebaseEvent('PostGen_action_block');
            ...
            children: [
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    logFirebaseEvent('POST_GEN_PAGE_Icon_us1607le_ON_TAP');
              ...
              InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  logFirebaseEvent('POST_GEN_PAGE_Text_i6ravk0r_ON_TAP');
                ...
                children: [
                      ...
                      if (currentUserEmailVerified) {
                        return Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'POST_GEN_PAGE_Container_yl5ulu52_ON_TAP');
                        ...
                        return Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'POST_GEN_PAGE_Container_nsipp6dj_ON_TAP');
                              logFirebaseEvent('Container_haptic_feedback');
                              HapticFeedback.lightImpact();
                              logFirebaseEvent('Container_bottom_sheet');
                              await showModalBottomSheet(
                  ...
                  AuthUserStreamWidget(
                    builder: (context) => InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'POST_GEN_PAGE_Container_617epe3m_ON_TAP');
                        logFirebaseEvent('Container_haptic_feedback');
                        HapticFeedback.lightImpact();
                      ...
                      children: [
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'POST_GEN_PAGE_Text_lvdg7gsv_ON_TAP');
                              logFirebaseEvent('Text_navigate_to');
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: FlutterFlowIconButton(
                                              ...
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'POST_GEN_PAGE_upload_ICN_ON_TAP');
                                                logFirebaseEvent(
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: TextFormField(
                              controller: _model.imagePromptTextController,
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        ToggleIcon(
                                          onPressed: () async {
                                            safeSetState(() => _model.aiVoice =
                                                !_model.aiVoice);
                                          },
                                          value: _model.aiVoice,
                                          onIcon: Icon(
                                            Icons.check_circle_outlined,
                                            color: FlutterFlowTheme.of(context)
                                                .primary,
                                      ...
                                      Align(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          onChanged: (val) async {
                                            ...
                                            logFirebaseEvent(
                                                'POST_GEN_DropDownVoice_ON_FORM_WIDGET_SE');
                                            logFirebaseEvent(
                        ...
                        Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'f5oz2smf' /* Create your own AI voice */,
                            ),
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    '0b16wqse' /* Upload a 3-5 minute audio and ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FlutterFlowIconButton(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'POST_GEN_graphic_eq_sharp_ICN_ON_TAP');
                                      logFirebaseEvent(
                                          'IconButton_upload_media_to_firebase');
                                      final selectedMedia =
                                          await selectMediaWithSourceBottomSheet(
                          ...
                          child: Row(
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'qjdqz0cy' /* Save AI Audio as a template */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                              ...
                              Align(
                                ...
                                child: FlutterFlowIconButton(
                                  ...
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'POST_GEN_PAGE_save_rounded_ICN_ON_TAP');
                                    logFirebaseEvent(
                                        'IconButton_upload_media_to_firebase');
                                    final selectedMedia =
                                        await selectMediaWithSourceBottomSheet(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'POST_GEN_PAGE_Container_vn19bdic_ON_TAP');
                                          logFirebaseEvent(
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'POST_GEN_PAGE_Container_54tjure9_ON_TAP');
                                        logFirebaseEvent(
                                            'Container_haptic_feedback');
                                        HapticFeedback.selectionClick();
                                        logFirebaseEvent(
                        ...
                        Align(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                '5ziuek2k' /* Background ImageVideo */,
                              ),
                              FFLocalizations.of(context).getText(
                                'i391y8r6' /* Pick a Color */,
                              )
                            ],
                            onChanged: (val) =>
                        ...
                        if (_model.dropDownValue == 'Pick a Color')
                          Padding(
                            padding: const EdgeInsetsDirectional.fromSTEB(
                                0.0, 10.0, 0.0, 10.0),
                            child: Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'POST_GEN_PAGE_Container_3j4mlmob_ON_TAP');
                        ...
                        if (_model.dropDownValue == 'Background Image/Video')
                          Align(
                            alignment: const AlignmentDirectional(0.0, 0.0),
                            child: Stack(
                              alignment: const AlignmentDirectional(0.0, 0.0),
                          ...
                          builder: (context, snapshot) {
                            ...
                            return wrapWithModel(
                              ...
                              child: TemplateScrollRefWidget(
                                templates: templateScrollRefTemplatesRecordList,
                              ),
                            );
                          },
                        ),
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'POST_GEN_PAGE_Container_t4n32bsw_ON_TAP');
                                  logFirebaseEvent('Container_bottom_sheet');
                                  await showModalBottomSheet(
                                    isScrollControlled: true,
                                    backgroundColor: Colors.transparent,
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'wsu55ctw' /* Upgrade to Unlock Unlimited Ge... */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                        ...
                        if (!(isWeb
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'POST_GEN_PAGE_GENERATE_VIDEO_BTN_ON_TAP');
                                ...
                                if (_model.imagePromptTextController.text !=
                                        '') {
                                  if (_model.imageSize != '') {
                                    ...
                                    FFAppState().tempImageDocument =
                                      ...
                                      userPrompt:
                                          _model.imagePromptTextController.text,
                                    ...
                                    safeSetState(() {
                                      _model.imagePromptTextController?.clear();
                                    });
                                    logFirebaseEvent(
